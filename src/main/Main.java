...
public class Main {
    public static void main(String[] args) {
        ...
        machine.addProduct(new Weightproduct("Гвозди", 10, 0.5));
        machine.addProduct(new Weightproduct("Халва",50, 3));
        ...
        System.out.println(machine.findProduct("Халва"));
        System.out.println("__________________________________");
        System.out.println("продан: " + machine.sellProduct(machine.findProduct("Twix").get(0)));
        System.out.println("продан: " + machine.sellProduct(machine.findProduct("Гвозди").get(0)));
        System.out.println("__________________________________");
        System.out.println(machine);
